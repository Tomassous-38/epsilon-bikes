...
export const FeaturedSection = () => {
  return (
    <section className="relative grid min-h-[1000px] border-red-500 overflow-hidden border-t-2 border-solid">
      <div className="bg-zinc-700 bg-[url('https://www.epsilon-bikes.com/wp-content/themes/epsilon-bikes/static/images/featured-heading-pattern.svg')] bg-no-repeat bg-size-[50%] bg-right px-6 md:px-16">
        <div className="max-w-screen-xl mx-auto py-12 md:py-16">
          <ScrollReveal direction="left">
            <h2 className="text-[32px] font-bold leading-10 overflow-clip md:text-5xl md:leading-[48px]">
              <span className="text-stone-100 text-[32px] inline-block leading-10 md:text-5xl md:leading-[48px]">
